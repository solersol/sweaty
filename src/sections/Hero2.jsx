...
// // const Hero2 = () => {
// //   return (
// //     <section className="w-full h-screen flex flex-col items-center justify-start p-8 text-white">
// //       {/* Logo at the top center */}
...
// const Hero2 = () => {
//   return (
//     <section className="w-full h-screen flex flex-col items-center justify-center mb-44 text-white">
//       {/* Logo at the top center */}
//       <div className="w-full flex justify-center mb-8">
//         <img src={logoMain} alt="Logo" className="w-[700px] h-auto" />
//       </div>
